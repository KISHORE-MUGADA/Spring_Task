...
public abstract class AbstractMongoDAO {
    ...
    //custom
    public <T extends AbstractMongoEntity> Collection<T> getAllReposits(Class<T> clazz) {
        return getMongoOperations().findAll(clazz,clazz.getSimpleName());
    }
    //custom
    public <T extends AbstractMongoEntity> Collection<T> getAllCustomers(Class<T> clazz) {
        return getMongoOperations().findAll(clazz,clazz.getSimpleName());
    }
    public <T extends AbstractMongoEntity> Collection<T> getAllCarts(Class<T> clazz) {
        return getMongoOperations().findAll(clazz,clazz.getSimpleName());
    }
    //custom
    public <T extends AbstractMongoEntity> Collection<T> getAllProducts(Class<T> clazz) {
        return getMongoOperations().findAll(clazz,clazz.getSimpleName());
    }
